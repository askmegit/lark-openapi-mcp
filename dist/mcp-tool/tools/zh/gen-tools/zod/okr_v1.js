...
exports.okrV1ProgressRecordCreate = {
    ...
    schema: {
        data: zod_1.z.object({
            ...
            target_id: zod_1.z.string().describe('目标 id，与 target_type 对应，可通过 OKR 内容相关接口获取'),
            ...
            progress_rate: zod_1.z
                .object({
                percent: zod_1.z.number().describe('进展百分比，保留两位小数').optional(),
                status: zod_1.z
                    .number()
...
exports.okrV1ProgressRecordGet = {
    ...
    path: '/open-apis/okr/v1/progress_records/:progress_id',
    httpMethod: 'GET',
    description: '[Feishu/Lark]-OKR-OKR 进展记录-获取 OKR 进展记录-根据 ID 获取 OKR 进展记录详情，接口返回进展记录的内容、更新时间以及进展百分比和状态',
    accessTokens: ['tenant', 'user'],
    schema: {
        params: zod_1.z
            .object({ user_id_type: zod_1.z.enum(['open_id', 'union_id', 'user_id']).describe('用户ID类型').optional() })
...
exports.okrV1UserOkrList = {
    ...
    schema: {
        ...
        path: zod_1.z.object({ user_id: zod_1.z.string().describe('目标用户id').optional() }).optional(),
        useUAT: zod_1.z.boolean().describe('使用用户身份请求, 否则使用应用身份').optional(),
    },
};
exports.okrV1Tools = [
