...
exports.apaasV1AppList = {
    ...
    httpMethod: 'GET',
    description: '[Feishu/Lark]-飞书 aPaaS-应用-查看应用基本信息-获取企业下应用基本信息，如应用名称 、应用命名空间等',
    accessTokens: ['user'],
    schema: {
        params: zod_1.z
            .object({
            page_size: zod_1.z.string().describe('分页大小，必填，范围：【0，50】').optional(),
            page_token: zod_1.z
                .string()
...
exports.apaasV1ApplicationAuditLogAuditLogList = {
    ...
    httpMethod: 'GET',
    description: '[Feishu/Lark]-飞书 aPaaS-审计日志-查询审计日志列表-根据搜索/筛选条件，查询审计日志列表',
    accessTokens: ['user'],
    schema: {
...
exports.apaasV1ApplicationAuditLogDataChangeLogDetail = {
    ...
    httpMethod: 'GET',
    description: '[Feishu/Lark]-飞书 aPaaS-审计日志-查询数据变更日志详情-根据日志 ID 查询数据变更日志详情',
    accessTokens: ['user'],
    schema: {
...
exports.apaasV1ApplicationAuditLogDataChangeLogsList = {
    ...
    httpMethod: 'GET',
    description: '[Feishu/Lark]-飞书 aPaaS-审计日志-查询数据变更日志列表-根据搜索/筛选条件，查询数据变更日志列表',
    accessTokens: ['user'],
    schema: {
        params: zod_1.z.object({
            quick_query: zod_1.z.string().describe('模糊查询').optional(),
...
exports.apaasV1ApplicationAuditLogGet = {
    ...
    httpMethod: 'GET',
    description: '[Feishu/Lark]-飞书 aPaaS-审计日志-查询审计日志详情-根据日志 ID 查询审计日志详情',
    accessTokens: ['user'],
    schema: {
        params: zod_1.z.object({ log_id: zod_1.z.string().describe('审计日志ID信息（通过[查询审计日志列表]获取单条日志ID）') }),
        path: zod_1.z.object({ namespace: zod_1.z.string().describe('应用命名空间') }),
        useUAT: zod_1.z.boolean().describe('使用用户身份请求, 否则使用应用身份').optional(),
    },
};
exports.apaasV1ApplicationEnvironmentVariableGet = {
    ...
    httpMethod: 'GET',
    description: '[Feishu/Lark]-飞书 aPaaS-环境变量-查询环境变量详情-查询基于飞书 aPaaS 开发的应用的环境变量详情，包括名称、描述、变量值等',
    accessTokens: ['tenant'],
    schema: {
        path: zod_1.z.object({
...
exports.apaasV1ApplicationEnvironmentVariableQuery = {
    ...
    httpMethod: 'POST',
    description: '[Feishu/Lark]-飞书 aPaaS-环境变量-查询环境变量列表-查询基于飞书 aPaaS 开发的应用的环境变量列表',
    accessTokens: ['tenant'],
    schema: {
        data: zod_1.z
            .object({
...
exports.apaasV1ApplicationFlowExecute = {
    ...
    httpMethod: 'POST',
    description: '[Feishu/Lark]-飞书 aPaaS-流程-操作流程-发起流程-执行相应流程',
    accessTokens: ['tenant'],
    schema: {
        data: zod_1.z.object({
...
exports.apaasV1ApplicationFunctionInvoke = {
    ...
    httpMethod: 'POST',
    description: '[Feishu/Lark]-飞书 aPaaS-函数-执行函数-执行基于飞书应用引擎开发的应用的自定义函数',
    accessTokens: ['tenant'],
    schema: {
        data: zod_1.z.object({ params: zod_1.z.string().describe('函数输入参数（JSON 序列化后的字符串）').optional() }).optional(),
        path: zod_1.z.object({
            namespace: zod_1.z.string().describe('应用命名空间'),
...
exports.apaasV1ApplicationObjectOqlQuery = {
    ...
    httpMethod: 'POST',
    description: '[Feishu/Lark]-飞书 aPaaS-对象-执行 OQL-在应用内执行 OQL 语句',
    accessTokens: ['tenant'],
    schema: {
        data: zod_1.z.object({
...
exports.apaasV1ApplicationObjectRecordBatchCreate = {
    ...
    httpMethod: 'POST',
    description: '[Feishu/Lark]-飞书 aPaaS-对象-批量新建记录-一次新建多条对象中的记录',
    accessTokens: ['tenant'],
    schema: {
        data: zod_1.z.object({
...
exports.apaasV1ApplicationObjectRecordBatchDelete = {
    ...
    httpMethod: 'DELETE',
    description: '[Feishu/Lark]-飞书 aPaaS-对象-批量删除记录-一次删除多条对象中的记录',
    accessTokens: ['tenant'],
    schema: {
...
exports.apaasV1ApplicationObjectRecordBatchQuery = {
    ...
    httpMethod: 'POST',
    description: '[Feishu/Lark]-飞书 aPaaS-对象-查询记录列表-获取对象中符合指定条件的记录列表',
    accessTokens: ['tenant'],
    schema: {
        data: zod_1.z.object({
...
exports.apaasV1ApplicationObjectRecordBatchUpdate = {
    ...
    httpMethod: 'PATCH',
    description: '[Feishu/Lark]-飞书 aPaaS-对象-批量编辑记录-一次编辑多条对象中的记录',
    accessTokens: ['tenant'],
    schema: {
        data: zod_1.z.object({
            records: zod_1.z.string().describe('记录详情列表，格式为 List<Map<string, ANY>>，操作记录数上限为 500 条'),
...
exports.apaasV1ApplicationObjectRecordCreate = {
    ...
    httpMethod: 'POST',
    description: '[Feishu/Lark]-飞书 aPaaS-对象-新建记录-在对象中新建记录',
    accessTokens: ['tenant'],
    schema: {
        data: zod_1.z.object({
...
exports.apaasV1ApplicationObjectRecordDelete = {
    ...
    httpMethod: 'DELETE',
    description: '[Feishu/Lark]-飞书 aPaaS-对象-删除记录-删除对象中的指定记录',
    accessTokens: ['tenant'],
    schema: {
        path: zod_1.z.object({
            namespace: zod_1.z.string().describe('应用命名空间'),
...
exports.apaasV1ApplicationObjectRecordPatch = {
    ...
    path: '/open-apis/apaas/v1/applications/:namespace/objects/:object_api_name/records/:id',
    httpMethod: 'PATCH',
    description: '[Feishu/Lark]-飞书 aPaaS-对象-编辑记录-编辑对象中的指定记录',
    accessTokens: ['tenant'],
    schema: {
        data: zod_1.z.object({
            record: zod_1.z.string().describe('创建对象使用的数据，键为字段 API 名称，值为字段值，格式可参考字段值格式'),
...
exports.apaasV1ApplicationObjectRecordQuery = {
    ...
    httpMethod: 'POST',
    description: '[Feishu/Lark]-飞书 aPaaS-对象-获取记录详情-获取对象中指定的记录详情',
    accessTokens: ['tenant'],
    schema: {
        data: zod_1.z
            .object({
...
exports.apaasV1ApplicationObjectSearch = {
    ...
    httpMethod: 'POST',
    description: '[Feishu/Lark]-飞书 aPaaS-对象-搜索记录-在应用内搜索记录',
    accessTokens: ['tenant'],
    schema: {
        data: zod_1.z
            .object({
...
exports.apaasV1ApplicationRecordPermissionMemberBatchCreateAuthorization = {
    ...
    httpMethod: 'POST',
    description: '[Feishu/Lark]-飞书 aPaaS-权限-记录权限-批量创建记录权限用户授权-批量创建记录权限授权',
    accessTokens: ['tenant'],
    schema: {
        data: zod_1.z
            .object({ user_ids: zod_1.z.array(zod_1.z.string()).describe('需要新增的用户 ID 列表，使用飞书 aPaaS 的用户 ID').optional() })
            .optional(),
        path: zod_1.z.object({
            namespace: zod_1.z.string().describe('应用命名空间'),
...
exports.apaasV1ApplicationRecordPermissionMemberBatchRemoveAuthorization = {
    ...
    httpMethod: 'POST',
    description: '[Feishu/Lark]-飞书 aPaaS-权限-记录权限-批量删除记录权限用户授权-批量删除记录权限授权',
    accessTokens: ['tenant'],
    schema: {
        data: zod_1.z
            .object({ user_ids: zod_1.z.array(zod_1.z.string()).describe('需要删除的用户 ID 列表，使用飞书 aPaaS 的用户 ID').optional() })
            .optional(),
        path: zod_1.z.object({
            namespace: zod_1.z.string().describe('应用命名空间'),
            record_permission_api_name: zod_1.z.string().describe('记录权限 API 名称'),
...
exports.apaasV1ApplicationRoleMemberBatchCreateAuthorization = {
    ...
    httpMethod: 'POST',
    description: '[Feishu/Lark]-飞书 aPaaS-权限-角色-批量创建角色成员授权-批量创建角色成员授权',
    accessTokens: ['tenant'],
    schema: {
        data: zod_1.z
            .object({
            user_ids: zod_1.z.array(zod_1.z.string()).describe('需要新增的用户 ID 列表，使用飞书 aPaaS 的用户 ID').optional(),
            department_ids: zod_1.z.array(zod_1.z.string()).describe('需要新增的部门 ID 列表，使用飞书 aPaaS 的部门 ID').optional(),
        })
            .optional(),
        path: zod_1.z.object({
            namespace: zod_1.z.string().describe('应用命名空间'),
...
exports.apaasV1ApplicationRoleMemberBatchRemoveAuthorization = {
    ...
    httpMethod: 'POST',
    description: '[Feishu/Lark]-飞书 aPaaS-权限-角色-批量删除角色成员授权-批量删除角色成员授权',
    accessTokens: ['tenant'],
    schema: {
        data: zod_1.z
            .object({
            user_ids: zod_1.z.array(zod_1.z.string()).describe('需要删除的用户 ID 列表，使用飞书 aPaaS 的用户 ID').optional(),
            department_ids: zod_1.z.array(zod_1.z.string()).describe('需要删除的部门 ID 列表，使用飞书 aPaaS 的部门 ID').optional(),
        })
            .optional(),
        path: zod_1.z.object({
            namespace: zod_1.z.string().describe('应用命名空间'),
...
exports.apaasV1ApplicationRoleMemberGet = {
    ...
    httpMethod: 'GET',
    description: '[Feishu/Lark]-飞书 aPaaS-权限-角色-查询角色成员信息-获取角色成员详情',
    accessTokens: ['tenant'],
    schema: {
        params: zod_1.z
            .object({
...
exports.apaasV1ApprovalInstanceCancel = {
    ...
    httpMethod: 'POST',
    description: '[Feishu/Lark]-飞书 aPaaS-流程-人工任务-撤销人工任务-撤销一个人工任务（包括审批任务，填写任务）',
    accessTokens: ['tenant'],
    schema: {
        data: zod_1.z.object({
...
exports.apaasV1ApprovalTaskAddAssignee = {
    ...
    httpMethod: 'POST',
    description: '[Feishu/Lark]-飞书 aPaaS-流程-人工任务-人工任务加签-对于人工任务进行加签操作',
    accessTokens: ['tenant'],
    schema: {
        data: zod_1.z.object({
...
exports.apaasV1ApprovalTaskAgree = {
    ...
    httpMethod: 'POST',
    description: '[Feishu/Lark]-飞书 aPaaS-流程-人工任务-同意人工任务-对于人工任务进行同意操作',
    accessTokens: ['tenant'],
    schema: {
...
exports.apaasV1ApprovalTaskReject = {
    ...
    httpMethod: 'POST',
    description: '[Feishu/Lark]-飞书 aPaaS-流程-人工任务-拒绝人工任务-对于人工任务进行拒绝操作',
    accessTokens: ['tenant'],
    schema: {
        data: zod_1.z.object({ user_id: zod_1.z.string().describe('操作人 ID'), opinion: zod_1.z.string().describe('审批意见').optional() }),
        path: zod_1.z.object({ approval_task_id: zod_1.z.string().describe('人工任务 ID') }),
...
exports.apaasV1ApprovalTaskTransfer = {
    ...
    httpMethod: 'POST',
    description: '[Feishu/Lark]-飞书 aPaaS-流程-人工任务-转交人工任务-对于人工任务进行转交操作',
    accessTokens: ['tenant'],
    schema: {
        data: zod_1.z.object({
            user_id: zod_1.z.string().describe('操作人 ID'),
...
exports.apaasV1SeatActivityList = {
    ...
    httpMethod: 'GET',
    description: '[Feishu/Lark]-飞书 aPaaS-席位活跃-查询席位活跃详情-获取租户下用户使用飞书 aPaaS 席位最近访问应用时间。需要飞书 aPaaS 系统管理员作为授权人调用当前API',
    accessTokens: ['user'],
    schema: {
        params: zod_1.z.object({
            seat_type: zod_1.z
...
exports.apaasV1SeatAssignmentList = {
    ...
    httpMethod: 'GET',
    description: '[Feishu/Lark]-飞书 aPaaS-席位分配-查询席位分配详情-获取租户下平台席位和应用访问席位分配详情，如用户 ID 、应用命名空间等，需要飞书 aPaaS 系统管理员作为授权人调用当前 API',
    accessTokens: ['user'],
    schema: {
        params: zod_1.z.object({
            seat_type: zod_1.z
...
exports.apaasV1UserTaskCc = {
    ...
    httpMethod: 'POST',
    description: '[Feishu/Lark]-飞书 aPaaS-流程-人工任务-抄送人工任务-对当前的任务进行一次抄送',
    accessTokens: ['tenant'],
    schema: {
        data: zod_1.z.object({
...
exports.apaasV1UserTaskChatGroup = {
    ...
    httpMethod: 'POST',
    description: '[Feishu/Lark]-飞书 aPaaS-流程-人工任务-基于人工任务发起群聊-基于任务，发起一个飞书群聊',
    accessTokens: ['tenant'],
    schema: {
        data: zod_1.z.object({
            operator_user_id: zod_1.z.string().describe('操作人kunlunUserID,可通过Apaas用户管理页面获取'),
...
exports.apaasV1UserTaskExpediting = {
    ...
    httpMethod: 'POST',
    description: '[Feishu/Lark]-飞书 aPaaS-流程-人工任务-催办人工任务-对任务当前的处理人发起一次催办',
    accessTokens: ['tenant'],
    schema: {
        data: zod_1.z.object({
            operator_user_id: zod_1.z.string().describe('操作人kunlunUserID,可通过Apaas用户管理页面获取'),
...
exports.apaasV1UserTaskQuery = {
    ...
    httpMethod: 'POST',
    description: '[Feishu/Lark]-飞书 aPaaS-流程-人工任务-查询人工任务-查询人工任务列表',
    accessTokens: ['tenant'],
    schema: {
        data: zod_1.z.object({
...
exports.apaasV1UserTaskRollback = {
    ...
    httpMethod: 'POST',
    description: '[Feishu/Lark]-飞书 aPaaS-流程-人工任务-退回人工任务-对当前任务进行一次退回',
    accessTokens: ['tenant'],
    schema: {
        data: zod_1.z.object({
            operator_user_id: zod_1.z.string().describe('操作人kunlunUserID,可通过Apaas用户管理页面获取'),
...
exports.apaasV1UserTaskRollbackPoints = {
    ...
    httpMethod: 'POST',
    description: '[Feishu/Lark]-飞书 aPaaS-流程-人工任务-查询人工任务可退回的位置-查询当前任务可以退回的位置',
    accessTokens: ['tenant'],
    schema: {
