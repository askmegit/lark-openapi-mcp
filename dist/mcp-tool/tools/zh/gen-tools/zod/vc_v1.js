...
exports.vcV1MeetingEnd = {
    ...
    schema: {
        path: zod_1.z
            .object({ meeting_id: zod_1.z.string().describe('会议ID（视频会议的唯一标识，视频会议开始后才会产生）').optional() })
            .optional(),
        useUAT: zod_1.z.boolean().describe('使用用户身份请求, 否则使用应用身份').optional(),
    },
};
...
exports.vcV1MeetingKickout = {
    ...
    schema: {
        ...
        params: zod_1.z
            .object({ user_id_type: zod_1.z.enum(['open_id', 'union_id', 'user_id']).describe('用户ID类型').optional() })
            .optional(),
        path: zod_1.z.object({ meeting_id: zod_1.z.string().describe('会议ID').optional() }).optional(),
    },
};
...
exports.vcV1MeetingRecordingStart = {
    ...
    accessTokens: ['user'],
    schema: {
        data: zod_1.z.object({ timezone: zod_1.z.number().describe('录制文件时间显示使用的时区[-12,12]').optional() }).optional(),
        path: zod_1.z
            .object({ meeting_id: zod_1.z.string().describe('会议ID（视频会议的唯一标识，视频会议开始后才会产生）').optional() })
            .optional(),
        useUAT: zod_1.z.boolean().describe('使用用户身份请求, 否则使用应用身份').optional(),
...
exports.vcV1ReserveConfigAdminGet = {
    ...
    schema: {
        ...
        path: zod_1.z.object({ reserve_config_id: zod_1.z.string().describe('会议室或层级id').optional() }).optional(),
    },
};
...
exports.vcV1ReserveDelete = {
    ...
    accessTokens: ['tenant', 'user'],
    schema: {
        path: zod_1.z.object({ reserve_id: zod_1.z.string().describe('预约ID（预约的唯一标识）').optional() }).optional(),
        useUAT: zod_1.z.boolean().describe('使用用户身份请求, 否则使用应用身份').optional(),
    },
};
...
exports.vcV1RoomLevelCreate = {
    ...
    schema: {
        data: zod_1.z.object({
            ...
            parent_id: zod_1.z
                .string()
                .describe('父层级ID。**说明**：如需在租户层级（即根层级）下创建会议室层级，可以先调用[查询会议室层级详情]接口，将路径参数 `room_level_id` 传入 `0` 进行查询，返回结果中的 `room_level_id` 值即为根层级 ID'),
