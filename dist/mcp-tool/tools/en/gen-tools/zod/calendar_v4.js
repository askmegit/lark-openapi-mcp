    ...
    schema: {
        params: zod_1.z
            ...
            max_attendee_num: zod_1.z
                .number()
                .describe('The maximum number of invitees returned. Call [Get event invitee list] to get complete invitee information of the event')
                .optional(),
            user_id_type: zod_1.z.enum(['open_id', 'union_id', 'user_id']).describe('User ID type').optional(),
        })
            .optional(),
        path: zod_1.z.object({
            calendar_id: zod_1.z
                .string()
                .describe('The calendar ID where the event is located. For information about calendar ID, please refer to [Calendar ID Description]'),
            event_id: zod_1.z
                .string()
                .describe('Event ID.The event ID is returned when creating a event. You can also call the following interface to obtain the ID of a certain calendar.- [Get event list]- [Search event]'),
        }),
...
exports.calendarV4CalendarEventList = {
    ...
    schema: {
        params: zod_1.z
            ...
            .optional(),
        path: zod_1.z.object({ calendar_id: zod_1.z.string().describe('Calendar ID. For details, see [Calendar-related IDs]') }),
        useUAT: zod_1.z.boolean().describe('Use user access token, otherwise use tenant access token').optional(),
    },
};
exports.calendarV4CalendarEventMeetingChatCreate = {
...
exports.calendarV4CalendarEventMeetingMinuteCreate = {
    ...
    schema: {
        path: zod_1.z.object({
            calendar_id: zod_1.z
                .string()
                .describe('Calendar ID. Call the [query primary calendar information] interface to obtain the primary calendar ID of the current identity'),
            event_id: zod_1.z
                .string()
                .describe('Event ID. Call the [Search event] interface to search for event in the specified calendar and obtain the event ID'),
        }),
        useUAT: zod_1.z.boolean().describe('Use user access token, otherwise use tenant access token').optional(),
    },
};
exports.calendarV4CalendarEventPatch = {
    ...
    schema: {
        data: zod_1.z
            ...
            recurrence: zod_1.z
                .string()
                .describe('Recurrence rule for recurring events. For details, see [RFC 5545].**Note**:- COUNT and UNTIL cannot coexist- The length of a scheduled recurring event in a room cannot exceed two years.**Default value**: empty, indicating that the field will not be updated')
                .optional(),
            schemas: zod_1.z
                .array(zod_1.z.object({
                ui_name: zod_1.z
        ...
        data: zod_1.z.object({
            ...
            filter: zod_1.z
                ...
                start_time: zod_1.z
                    ...
                    date: zod_1.z
                        .string()
                        .describe('Specify the start time in days, in [RFC 3339] format, for example, 2018-09-01.**Note**: This parameter cannot be specified at the same time as `timestamp`')
                        .optional(),
                    timestamp: zod_1.z
                        .string()
                ...
                end_time: zod_1.z
                    ...
                    date: zod_1.z
                        .string()
                        .describe('Specify the end time in days, in [RFC 3339] format, for example, 2018-09-01.**Note**: This parameter cannot be specified at the same time as `timestamp`')
                        .optional(),
                    timestamp: zod_1.z
                        .string()
                ...
                chat_ids: zod_1.z
                    .array(zod_1.z.string())
                    .describe('Search filter items, group ID list. After setting this field, the searched event contains at least one of these groups. For details about group ID, please refer to [Group ID Description].**Default value**: empty, indicating that the filter item is not set')
                    .optional(),
            })
...
exports.calendarV4CalendarSubscribe = {
    ...
    schema: {
        path: zod_1.z.object({
            calendar_id: zod_1.z
                .string()
                .describe('Calendar ID.The calendar ID will be returned when creating a shared calendar. You also can call the following interfaces to get the ID of a certain calendar.- [Query Primary Calendar Information]- [Query Calendar List]- [Search Calendar]'),
        }),
        useUAT: zod_1.z.boolean().describe('Use user access token, otherwise use tenant access token').optional(),
    },
};
exports.calendarV4CalendarSubscription = {
    ...
    httpMethod: 'POST',
    description: '[Feishu/Lark]-Calendar-Calendar management-Subscribe Calendar Changes -Call this interface to subscribe the current user identity to the [Calendar Change Event]',
    accessTokens: ['user'],
    schema: {
        useUAT: zod_1.z.boolean().describe('Use user access token, otherwise use tenant access token').optional(),
    },
...
exports.calendarV4CalendarUnsubscribe = {
    ...
    schema: {
        path: zod_1.z.object({
            calendar_id: zod_1.z
                .string()
                .describe('Calendar ID.You can call the following interfaces to get the ID of a calendar.- [Query primary calendar information]- [Query calendar list]- [Search calendar]'),
        }),
        useUAT: zod_1.z.boolean().describe('Use user access token, otherwise use tenant access token').optional(),
    },
};
exports.calendarV4CalendarUnsubscription = {
    ...
    httpMethod: 'POST',
    description: '[Feishu/Lark]-Calendar-Calendar management-Unsubscribe Calendar Changes-Call this interface to unsubscribe the current user identity from the [Calendar Change Event]',
    accessTokens: ['user'],
    schema: {
        useUAT: zod_1.z.boolean().describe('Use user access token, otherwise use tenant access token').optional(),
    },
...
exports.calendarV4ExchangeBindingCreate = {
    ...
    schema: {
        data: zod_1.z
            ...
            user_id: zod_1.z
                .string()
                .describe('User ID, that is, the Feishu account ID bound to the Exchange account. For more information, see [User-related IDs]')
                .optional(),
        })
            .optional(),
        params: zod_1.z
    ...
    schema: {
        path: zod_1.z.object({
            exchange_binding_id: zod_1.z
                .string()
                .describe('The unique identification ID bound to Exchange. When calling [Bind Exchange Account to Feishu Account], the exchange_binding_id can be obtained from the returned result'),
        }),
        useUAT: zod_1.z.boolean().describe('Use user access token, otherwise use tenant access token').optional(),
    },
};
...
exports.calendarV4FreebusyList = {
    ...
    schema: {
        data: zod_1.z.object({
            time_min: zod_1.z
                .string()
                .describe('The start time of the query period, in [RFC 3339] date_time format.**Note**: The time interval between time_min and time_max cannot be more than 90 days'),
            time_max: zod_1.z
                .string()
                .describe('The end time of the query period, in [RFC 3339] date_time format.**Note**: The time interval between time_min and time_max cannot be more than 90 days'),
            user_id: zod_1.z
                .string()
                .describe("User ID, you need to input an id that matches the query parameter user_id_type. For example, when user_id_type=open_id, you need to input the user's open_id. Refer to [User-related ID concepts] for understanding user IDs.**Note**: Either user_id or room_id needs to be entered. If both are entered at the same time, only user_id will take effect")
                .optional(),
            room_id: zod_1.z
                .string()
                .describe("Meeting room room_id. You can call the [Query Meeting Room List] interface or the [Search for Meeting Room] interface to get the corresponding meeting room's room_id.**Note**: Either user_id or room_id needs to be entered. If both are entered at the same time, only user_id will take effect")
                .optional(),
...
exports.calendarV4TimeoffEventCreate = {
    ...
    schema: {
        data: zod_1.z.object({
            user_id: zod_1.z
                .string()
                .describe('User ID. The ID type needs to be consistent with the value of user_id_type. For information about user IDs, see [User-related ID concepts]'),
