...
exports.attendanceV1ApprovalInfoProcess = {
    ...
    schema: {
        data: zod_1.z.object({
            approval_id: zod_1.z
                .string()
                .describe('Approval sample ID. How to access: 1) [Get Granted Approval Data] 2) [Write Approval Result] 3) [Notify of Correction Request Submission (in the case of correction)]'),
...
exports.attendanceV1ArchiveRuleList = {
    ...
    httpMethod: 'GET',
    description: '[Feishu/Lark]-Attendance-archive_report-Query all archived reports-Query all archiving rules, corresponding to the background fake attendance management - attendance statistics - reports - [archived reports] function',
    accessTokens: ['tenant', 'user'],
    schema: {
        params: zod_1.z
            .object({
    ...
    schema: {
        data: zod_1.z.object({
            group: zod_1.z
                ...
                group_id: zod_1.z
                    .string()
                    .describe('Attendance group ID (only provided when modifying), you need to query the attendance group by name from [query attendance groups by name] or [query all attendance groups] Get groupId in the interface. If not, a new attendance group will be created')
                    .optional(),
                ...
                out_punch_need_post_approval: zod_1.z
                    .boolean()
                    .describe('The clock in the field needs to be approved, and the clock in is approved first (you need to allow the clock in the field to be set to take effect)')
                    .optional(),
                ...
                out_punch_allowed_adjust_addr: zod_1.z
                    .boolean()
                    .describe('The field clock in allows fine-tuning of the address (you need to allow the field clock in order to set it to take effect)')
                    .optional(),
                adjust_range: zod_1.z.number().describe('Fine-tuning range, default is 50 meters').optional(),
                ...
                hide_staff_punch_time: zod_1.z
                    ...
                    .optional(),
                hide_clock_in_rule: zod_1.z.boolean().describe('Hide the clock in action').optional(),
                face_punch: zod_1.z
                    .boolean()
                ...
                anti_cheat_punch_config: zod_1.z
                    ...
                    intercept_suspected_cheat_punch: zod_1.z
                        .boolean()
                        .describe('Whether to intercept the suspected cheating clock in, turn it off/not update by default when not passing in; when it is closed, the rest of the anti-cheating switches will be turned off'),
                    check_cheat_software_punch: zod_1.z
                        .boolean()
                        .describe('Whether to check the clock in the suspected cheating software, and close/not update by default when not passing in')
                        .optional(),
                    check_buddy_punch: zod_1.z
                        .boolean()
                        .describe('Whether to check whether it is suspected that someone else clocked in on behalf of others, it will be closed/not updated by default when not passing in')
                        .optional(),
                    check_simulate_wifi_punch: zod_1.z
                        .boolean()
                        .describe('Whether to check the suspected simulated WI-FI clock in, turn off/not update by default when not passing in (only valid for grey release tenants, please contact technical support if you need to use it.)')
                        .optional(),
                    check_change_device_punch: zod_1.z
                        .boolean()
                        .describe('Whether to check the replacement device clock in, turn off/not update by default when not passing in')
                        .optional(),
                    allow_change_device_num: zod_1.z
                        .number()
                        .describe('The same member of the attendance team can bind up to the upper limit of the number of clocks in the device, and it is required to fill in the replacement device clock in the verification')
                        .optional(),
                    suspected_cheat_handle_method: zod_1.z
                        .number()
                        .describe('The processing method when the clock in suspected cheating is turned on. Required when the clock in suspected cheating is turned on Options:1(use_face_punch The clock in facial recognition),2(only_record_cheat_info Only record suspected cheating information)')
                        .optional(),
                })
                    .describe('Anti-cheat clock in configuration, off/not updated by default when not passing in (only valid for grey release tenants, please contact technical support if you need to use it.)')
                    .optional(),
                machines: zod_1.z
                    .array(zod_1.z.object({
                ...
                punch_day_shift_ids: zod_1.z
                    .array(zod_1.z.string())
                    .describe('The fixed shift schedule must be filled in, and 7 must be filled in (from Monday to Sunday). Shift IDs can be obtained by [Query all shifts] and [Query shifts by name]'),
                ...
                leave_need_punch_cfg: zod_1.z
                    ...
                    not_during_shift: zod_1.z
                        .boolean()
                        .describe('Leave in the middle of the shift, no need to clock in before leaving or after returning (only valid for grey release tenants, please contact technical support if you need to use it)')
                        .optional(),
                })
                ...
                go_out_need_punch_cfg: zod_1.z
                    ...
                    not_during_shift: zod_1.z
                        .boolean()
                        .describe('Out in the middle of the shift, no need to clock in before leaving or after returning (only valid for grey release tenants, please contact technical support if you need to use it)')
                        .optional(),
                })
                    .describe('Whether the clock is required during the business trip, the default is empty')
                    .optional(),
                travel_need_punch: zod_1.z.number().describe('Rules of the clock in minutes during business trips').optional(),
                travel_need_punch_cfg: zod_1.z
                    ...
                    not_during_shift: zod_1.z
                        .boolean()
                        .describe('There is no need to clock in before leaving or after returning from business trips (business trips are not valid)')
                        .optional(),
                })
                ...
                overtime_clock_cfg: zod_1.z
                    ...
                    allow_punch_approval: zod_1.z
                        .boolean()
                        .describe('Whether to allow applications to clock in non-clocking hours (only valid for grey release tenants, please contact technical support if you need to use it.)')
                        .optional(),
                    need_clock_over_time_start_and_end: zod_1.z
                        .boolean()
                        .describe('Overtime starts and ends clocked in (only valid for grey release tenants, please contact technical support if you need to use it.)')
                        .optional(),
                })
                ...
                new_calendar_id: zod_1.z
                    .string()
                    .describe('Holiday id, (if the attendance group uses a custom holiday, use this parameter to pass in the holiday id, you can get it from the Settings-Holiday Module page path)')
                    .optional(),
                allow_apply_punch: zod_1.z
                    .boolean()
                ...
                clock_in_abnormal_settings: zod_1.z
                    ...
                    ignore_until_latest_clockout: zod_1.z
                        .boolean()
                        .describe('Ignore exception cards before the latest clock in time (only valid for grey release tenants, please contact technical support if you need to use it.)')
                        .optional(),
                })
            ...
            operator_id: zod_1.z
                .string()
                .describe('Operator uid, corresponding to employee_type, if you do not operate [backstage for attendance management "API access" process], this field is required field')
                .optional(),
        }),
        params: zod_1.z.object({
            employee_type: zod_1.z
            ...
            dept_type: zod_1.z
                .literal('open_id')
                .describe('Type of department ID Options:open_id(For the time being, only the openid of the department is supported. For specific concepts, please refer to the open_department_id in [Department Resource Introduction])'),
        }),
    },
};
exports.attendanceV1GroupDelete = {
    ...
    httpMethod: 'DELETE',
    description: '[Feishu/Lark]-Attendance-Attendance group-Delete attendance group-Delete the attendance group through the attendance group ID. Corresponding Settings - False Attendance Settings - Delete Function of [Attendance Group] Operation Columns',
    accessTokens: ['tenant'],
    schema: {
        path: zod_1.z.object({
            group_id: zod_1.z
                .string()
                .describe('Attendance group ID is obtained as follows: 1) [Create or modify attendance groups] 2) [Query attendance group by name] 3) [Obtain attendance results]'),
        }),
    },
};
exports.attendanceV1GroupGet = {
    ...
    schema: {
        params: zod_1.z.object({
            ...
            dept_type: zod_1.z
                .literal('open_id')
                .describe('Department ID type Options:open_id(For the time being, only the openid of the department is supported. For specific concepts, please refer to the open_department_id in [Department Resource Introduction])'),
        }),
        path: zod_1.z.object({
            group_id: zod_1.z
                .string()
...
exports.attendanceV1GroupListUser = {
    ...
    schema: {
        params: zod_1.z.object({
            employee_type: zod_1.z
                .string()
                .describe('Response body user_id employee ID type. If you do not have backend management permissions, you can use [Get user ID by mobile phone number or email]<b>Optional values are</b>:1. employee_id: Employee ID, which is the user ID in [Feishu admin background] > organizational structure > members and departments > member detailsDetails2. employee_no: Employee job number, that is, the job number in [Feishu management background] > organizational structure > members and departments > member details'),
            dept_type: zod_1.z
                .string()
                .describe('Response body department_ids type of department ID.<b>Optional values are</b>:1. open_id: For the time being, only the openid of the department is supported. For specific concepts, please refer to the open_department_id in [Department Resource Introduction]'),
...
exports.attendanceV1LeaveAccrualRecordPatch = {
    ...
    httpMethod: 'PATCH',
    description: '[Feishu/Lark]-Attendance-Leave Grant Records-Modify Grant Record-Update the number and expiration date of issuance records, corresponding to leave management - leave management - [issuance records]',
    accessTokens: ['tenant'],
    schema: {
        data: zod_1.z.object({
            ...
            leave_type_id: zod_1.z.string().describe('The holiday type ID can be obtained by [Get a list of holiday types]'),
            reason: zod_1.z
                .array(zod_1.z.object({
...
exports.attendanceV1ShiftDelete = {
    ...
    httpMethod: 'DELETE',
    description: '[Feishu/Lark]-Attendance-Attendance shift-Delete Attendance Shift-Delete the shift by the shift ID. The corresponding function is the Delete button in the operation bar in the shift list of false attendance settings - [shift settings]',
    accessTokens: ['tenant'],
    schema: {
        path: zod_1.z.object({
            shift_id: zod_1.z
...
exports.attendanceV1ShiftGet = {
    ...
    path: '/open-apis/attendance/v1/shifts/:shift_id',
    httpMethod: 'GET',
    description: '[Feishu/Lark]-Attendance-Attendance shift-Query shifts by ID-Get the shift details through the shift ID. The corresponding function is fake duty settings - [shift settings] The specific shift in the shift list, the shift information can be viewed by clicking the shift name',
    accessTokens: ['tenant'],
    schema: {
        path: zod_1.z.object({
            shift_id: zod_1.z
...
exports.attendanceV1ShiftList = {
    ...
    path: '/open-apis/attendance/v1/shifts',
    httpMethod: 'GET',
    description: '[Feishu/Lark]-Attendance-Attendance shift-Query all shifts-Fake duty settings in Feishu personnel management background - [Shift configuration] page turn query all shift functions, showing shift name, clock in rules, flexible shift rules, rest rules, etc',
    accessTokens: ['tenant'],
    schema: {
        params: zod_1.z
            .object({
...
exports.attendanceV1ShiftQuery = {
    ...
    httpMethod: 'POST',
    description: '[Feishu/Lark]-Attendance-Attendance shift-Query Attendance Shift by Name-Feishu personnel management background fake work settings - [shift configuration] in the search shift name function, showing shift name, clock in rules, flexible shift rules, rest rules, etc',
    accessTokens: ['tenant'],
    schema: {
        ...
        data: zod_1.z
            ...
            user_approval: zod_1.z
                ...
                leaves: zod_1.z
                    ...
                    uniq_id: zod_1.z
                        .string()
                        .describe('Vacation type unique ID, representing a vacation type, less than 14 in length* This ID corresponds to the holiday type (ie: i18n_names), so it needs to be guaranteed to be unique. You can get [Get Holiday Type]')
                        .optional(),
                    unit: zod_1.z
                        .number()
                ...
                overtime_works: zod_1.z
                    ...
                    duration: zod_1.z
                        .number()
                        .describe('If you need to use this field to calculate overtime hours, please contact [Technical Support] to open. start_time and end_time calculation are used by default'),
                    unit: zod_1.z
                        .number()
                ...
                trips: zod_1.z
                    ...
                    departure: zod_1.z
                        ...
                        region_id: zod_1.z
                            .string()
                            .describe('Geographic ID, it can be obtained by [querying district/county information] or [querying city information] (only supported by Feishu People Enterprise)')
                            .optional(),
                    })
                    ...
                    .describe('Travel information.Currently only full-day travel is supported (less than full days are counted as full days). If you need to support half-day travel, please consult [Technical Support]')
                    .optional(),
                time_zone: zod_1.z
                    .string()
    ...
    schema: {
        data: zod_1.z.object({
            user_daily_shifts: zod_1.z
                ...
                shift_id: zod_1.z
                    .string()
                    .describe('Shift ID, which can be obtained as follows: 1) [Search shift by name] 2) [Create a shift].Passing in 0 represents rest'),
            ...
            operator_id: zod_1.z
                .string()
                .describe('Operator uid, corresponding to employee_type. If you do not operate [backstage for attendance management "API access" process], this field is required')
                .optional(),
        }),
        params: zod_1.z.object({
            employee_type: zod_1.z
...
exports.attendanceV1UserFlowBatchDel = {
    ...
    schema: {
        data: zod_1.z.object({
            record_ids: zod_1.z
                .array(zod_1.z.string())
                .describe('Attendance flow record ID, which is obtained as follows: 1) [Batch query of attendance flow record] 2) [Obtain attendance results] 3) [Import attendance flow record]'),
        }),
    },
};
    ...
    schema: {
        data: zod_1.z
            ...
            user_setting: zod_1.z
                ...
                face_key: zod_1.z.string().describe('Face photo file ID, get method: [Upload user facial recognition photo]'),
...
exports.attendanceV1UserStatsViewUpdate = {
    ...
    schema: {
        ...
        path: zod_1.z.object({
            user_stats_view_id: zod_1.z.string().describe('User view ID is obtained as follows: 1) [Query statistics settings]'),
        }),
    },
};
exports.attendanceV1UserTaskRemedyCreate = {
    ...
    httpMethod: 'POST',
    description: '[Feishu/Lark]-Attendance-Attendance correction-Notify correction approval initiation-For enterprises that only use Fishu attendance system but not Fishu approval system, you can use this interface to write the replacement card approval data initiated in the three-party approval system to Fishu attendance system with the status of approval in progress. The status can be updated by [notify approval status update] after writing in',
    accessTokens: ['tenant'],
    schema: {
        data: zod_1.z.object({
