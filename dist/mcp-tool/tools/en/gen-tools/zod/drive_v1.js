    ...
    schema: {
        data: zod_1.z.object({
            file_extension: zod_1.z
                ...
                .describe('The file extension of the local file after exporting the cloud document. To understand the file formats supported for exporting various cloud documents, refer to the [Export docs overview]. Options:docx(Microsoft Word (DOCX) format),pdf(PDF format),xlsx(Microsoft Excel (XLSX) format),csv(CSV format)'),
            token: zod_1.z.string().describe('The token of the cloud document. For details, see [How to get document token]'),
            type: zod_1.z
...
exports.driveV1ExportTaskGet = {
    ...
    schema: {
        ...
        path: zod_1.z.object({ ticket: zod_1.z.string().describe('Export task ID, call [Create export task] to get the ID') }),
        useUAT: zod_1.z.boolean().describe('Use user access token, otherwise use tenant access token').optional(),
    },
};
exports.driveV1FileCommentBatchQuery = {
    ...
    schema: {
        ...
        path: zod_1.z.object({ file_token: zod_1.z.string().describe('Document token').optional() }).optional(),
        useUAT: zod_1.z.boolean().describe('Use user access token, otherwise use tenant access token').optional(),
    },
};
    ...
    schema: {
        data: zod_1.z.object({
            ...
            folder_token: zod_1.z
                .string()
                .describe('The target folder token to which the file is copied. Learn how to get the folder token, see [Folder overview]'),
            extra: zod_1.z
                .array(zod_1.z.object({
...
exports.driveV1FileCreateFolder = {
    ...
    schema: {
        data: zod_1.z.object({
            ...
            folder_token: zod_1.z
                .string()
                .describe('Parent folder token. This parameter can be an empty string, which means the folder will be created in the root folder. You can refer to [List items in folder] to get other level folder. For details, see [Folder overview]'),
        }),
        useUAT: zod_1.z.boolean().describe('Use user access token, otherwise use tenant access token').optional(),
    },
};
    ...
    schema: {
        data: zod_1.z.object({
            parent_token: zod_1.z
                .string()
                .describe('The token of the target folder into which the file is copied. For how to get the folder token, see [Folder overview]'),
            refer_entity: zod_1.z
                .object({
                refer_token: zod_1.z
                    .string()
                    .describe('The token of the file that needs to be copied. For how to get the file token, see [File overview]'),
                refer_type: zod_1.z
...
exports.driveV1FileDelete = {
    ...
    schema: {
        ...
        path: zod_1.z
            ...
            file_token: zod_1.z
                .string()
                .describe("File's or folder's token that needs to be moved.To learn how to get the file token, see [File overview].To learn how to get the folder token, see [Folder overview]")
                .optional(),
        })
            .optional(),
        useUAT: zod_1.z.boolean().describe('Use user access token, otherwise use tenant access token').optional(),
...
exports.driveV1FileDeleteSubscribe = {
    ...
    schema: {
        ...
        path: zod_1.z.object({ file_token: zod_1.z.string().describe('Document token. For details, see [FAQs]') }),
        useUAT: zod_1.z.boolean().describe('Use user access token, otherwise use tenant access token').optional(),
    },
};
...
exports.driveV1FileStatisticsGet = {
    ...
    schema: {
        ...
        path: zod_1.z
            .object({ file_token: zod_1.z.string().describe('File token. For details, see [File overview]').optional() })
            .optional(),
        useUAT: zod_1.z.boolean().describe('Use user access token, otherwise use tenant access token').optional(),
    },
};
...
exports.driveV1FileUploadFinish = {
    ...
    httpMethod: 'POST',
    description: '[Feishu/Lark]-Docs-Space-File-Upload files-Multipart Upload-Upload a file in blocks-Completing-Completes an upload task',
    accessTokens: ['tenant', 'user'],
    schema: {
        data: zod_1.z.object({
            upload_id: zod_1.z
                .string()
                .describe('ID of the block upload transaction. You can call the [Upload a file in blocks-Pre­uploading] to get the upload ID'),
            block_num: zod_1.z
                .number()
                .describe('Number of blocks. You can call the [Upload a file in blocks-Pre­uploading] to get the number of blocks'),
        }),
        useUAT: zod_1.z.boolean().describe('Use user access token, otherwise use tenant access token').optional(),
    },
};
exports.driveV1FileUploadPrepare = {
    ...
    schema: {
        data: zod_1.z.object({
            ...
            parent_node: zod_1.z.string().describe('Token of the folder. For details, see [Cloud space overview]'),
...
exports.driveV1FileVersionGet = {
    ...
    schema: {
        ...
        path: zod_1.z.object({
            file_token: zod_1.z.string().describe('document token. For how to get the document token, see [Docs overview]'),
            version_id: zod_1.z.string().describe('document version ID'),
        }),
        useUAT: zod_1.z.boolean().describe('Use user access token, otherwise use tenant access token').optional(),
    },
...
exports.driveV1FileVersionList = {
    ...
    schema: {
        ...
        path: zod_1.z.object({
            file_token: zod_1.z
                .string()
                .describe('parent document token. For how to get the document token. see [How to get the token of docs resources]'),
        }),
        useUAT: zod_1.z.boolean().describe('Use user access token, otherwise use tenant access token').optional(),
    },
};
exports.driveV1FileViewRecordList = {
    ...
    schema: {
        ...
        path: zod_1.z.object({ file_token: zod_1.z.string().describe('File token. For how to get tokens, see [File overview]') }),
        useUAT: zod_1.z.boolean().describe('Use user access token, otherwise use tenant access token').optional(),
    },
};
exports.driveV1ImportTaskCreate = {
    ...
    schema: {
        data: zod_1.z.object({
            file_extension: zod_1.z
                .string()
                .describe('The extension of the file to be imported. To learn about supported file formats, refer to [Import File Overview].**Note**: The file extensions filled in here need to be strictly consistent with the suffixes of the actual files. Please be careful to distinguish Markdown files with suffixes ‘markdown’, ‘md’, ‘mark’, and keep the suffixes consistent when you fill in the relevant parameters. Otherwise, an error code 1069910 will be returned. Otherwise, 1069910 error code will be returned'),
            file_token: zod_1.z
                .string()
                .describe('To import a file token, you need to call the [upload material] or [upload file] to get the token of the source file before creating an import task. To learn more, refer to [Import file overview]'),
            type: zod_1.z
                .string()
                .describe('Target cloud document format. Different files support different cloud document formats. Refer to [Import File Overview] for details. The optional values are shown below:- `docx`: new version of document- `sheet`: spreadsheet- `bitable`: multidimensional table'),
            file_name: zod_1.z
                .string()
            ...
            point: zod_1.z
                ...
                mount_key: zod_1.z
                    .string()
                    .describe('The token of the folder where the cloud document is mounted, i.e., the token of the folder under the cloud space. empty indicates the cloud space root directory. To learn how to get folder tokens, refer to [folder-overview]'),
            })
...
exports.driveV1ImportTaskGet = {
    ...
    httpMethod: 'GET',
    description: '[Feishu/Lark]-Docs-Space-File-Import files-Query import task result-Polling the import results based on the `ticket` returned from [Create import task]. For details, see [Import file overview]',
    accessTokens: ['tenant', 'user'],
    schema: {
        path: zod_1.z.object({ ticket: zod_1.z.string().describe('ID of the import task. Call [Create import task] to get the ID') }),
        useUAT: zod_1.z.boolean().describe('Use user access token, otherwise use tenant access token').optional(),
    },
};
...
exports.driveV1MediaUploadFinish = {
    ...
    schema: {
        data: zod_1.z.object({
            ...
            block_num: zod_1.z.number().describe('The number of blocks. Obtain this by calling the [Preupload media] interface'),
        }),
        useUAT: zod_1.z.boolean().describe('Use user access token, otherwise use tenant access token').optional(),
    },
};
exports.driveV1MediaUploadPrepare = {
    ...
    schema: {
        data: zod_1.z.object({
            ...
            parent_node: zod_1.z
                .string()
                .describe('The token of the upload point, which is the token of the cloud document to be uploaded, used to specify the cloud document or location where the media will be uploaded. Refer to [Media Overview] to understand the relationship between the upload point type and the upload point token'),
            size: zod_1.z.number().describe('The size of the file, in bytes'),
            extra: zod_1.z
                .string()
                .describe('The upload points in the following scenarios need to pass the token of the cloud document where the material is located through this parameter. The format of the extra parameter is `"{\\"drive_route_token\\":\\"token of the cloud document where the material is located\\"}"`. For details, refer to [Material Overview]')
                .optional(),
        }),
        useUAT: zod_1.z.boolean().describe('Use user access token, otherwise use tenant access token').optional(),
    },
...
exports.driveV1PermissionMemberAuth = {
    ...
    schema: {
        ...
        path: zod_1.z.object({
            token: zod_1.z
                .string()
                .describe('Token of the file. For more information about how to obtain the token, see [How to get the token of docs resources]'),
        }),
        useUAT: zod_1.z.boolean().describe('Use user access token, otherwise use tenant access token').optional(),
    },
};
...
exports.driveV1PermissionMemberCreate = {
    ...
    httpMethod: 'POST',
    description: '[Feishu/Lark]-Docs-Permission-Member-Add permissions-Add collaborators to the specified cloud document. Collaborators can be users, groups, departments, user groups, etc',
    accessTokens: ['tenant', 'user'],
    schema: {
        data: zod_1.z.object({
            member_type: zod_1.z
                .enum(['email', 'openid', 'unionid', 'openchat', 'opendepartmentid', 'userid', 'groupid', 'wikispaceid'])
                .describe('Collaborator type, which needs to match the collaborator id Options:email(Email),openid(open_id The Open ID of the application or user. - To get the application OpenID, refer to [How to get the application open_id] - Get user OpenID, refer to [How to get different user IDs]),unionid(union_id Open platform unionID),openchat(open_chat Open platform chat ID),opendepartmentid(open_department_id Open platform department ID),userid(user_id User customized ID),groupid(group_id Custom user group ID),wikispaceid(wiki_space_id Wiki space ID - **NOTE**: This parameter is only supported by the wiki document, and it is required when you need to operate the "wiki space member" type collaborator in the wiki document)'),
...
exports.driveV1PermissionPublicGet = {
    ...
    httpMethod: 'GET',
    description: '[Feishu/Lark]-Deprecated Version (Not Recommended)-Docs-Permission Setting v1-GetPermissionPublic-This interface is used to obtain permission settings for cloud documents according to filetoken',
    accessTokens: ['tenant', 'user'],
    schema: {
        params: zod_1.z.object({
            type: zod_1.z
...
exports.driveV1PermissionPublicPasswordCreate = {
    ...
    httpMethod: 'POST',
    description: '[Feishu/Lark]-Docs-Permission-password-Open password-This interface is used to enable the password of the cloud document according to the filetoken',
    accessTokens: ['tenant', 'user'],
    schema: {
        params: zod_1.z.object({
            type: zod_1.z
...
exports.driveV1PermissionPublicPasswordDelete = {
    ...
    path: '/open-apis/drive/v1/permissions/:token/public/password',
    httpMethod: 'DELETE',
    description: '[Feishu/Lark]-Docs-Permission-password-Close password-This interface is used to disable the password of cloud doc more filetoken',
    accessTokens: ['tenant', 'user'],
    schema: {
        params: zod_1.z.object({
            type: zod_1.z
...
exports.driveV1PermissionPublicPasswordUpdate = {
    ...
    path: '/open-apis/drive/v1/permissions/:token/public/password',
    httpMethod: 'PUT',
    description: '[Feishu/Lark]-Docs-Permission-password-Refresh password-This interface is used to refresh the password of cloud doc more filetoken',
    accessTokens: ['tenant', 'user'],
    schema: {
        params: zod_1.z.object({
            type: zod_1.z
...
exports.driveV1PermissionPublicPatch = {
    ...
    path: '/open-apis/drive/v1/permissions/:token/public',
    httpMethod: 'PATCH',
    description: '[Feishu/Lark]-Deprecated Version (Not Recommended)-Docs-Permission Setting v1-Update document sharing settings-This API is used to update the common settings of a document based on a filetoken',
    accessTokens: ['tenant', 'user'],
    schema: {
        data: zod_1.z
            .object({
