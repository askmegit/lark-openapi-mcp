...
exports.payrollV1Tools = exports.payrollV1DatasourceList = exports.payrollV1DatasourceRecordSave = exports.payrollV1DatasourceRecordQuery = exports.payrollV1CostAllocationReportList = exports.payrollV1CostAllocationPlanList = exports.payrollV1CostAllocationDetailList = void 0;
...
exports.payrollV1CostAllocationDetailList = {
    ...
    httpMethod: 'GET',
    description: '[Feishu/Lark]-Payroll-cost allocation detail-query details on cost allocation reports-Obtain detailed cost allocation data based on report plan, period and report type. Before invoking the interface, the "financial Posting" switch should be turned on and the cost allocation report should be published',
    ...
    schema: {
        params: zod_1.z.object({
            ...
            report_type: zod_1.z.number().describe('Report type Options:0(Default),1(Accrued),2(Paid)'),
        }),
...
exports.payrollV1CostAllocationPlanList = {
    ...
    schema: {
        params: zod_1.z.object({
            ...
            pay_period: zod_1.z
                .string()
                .describe('During the period, generate the year and month corresponding to the cost allocation report. The format is yyyy-MM'),
        }),
    },
};
...
exports.payrollV1DatasourceRecordSave = {
    ...
    schema: {
        data: zod_1.z.object({
            source_code: zod_1.z
                .string()
                .describe('Data source code. External data source configuration information can be obtained from [https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/payroll-v1/datasources/list]Or on the "Feishu Personnel Background - Settings - Salary Data Settings - External Data Source Configuration" page, get'),
            records: zod_1.z
                .array(zod_1.z.object({
